<template>
  <div id="controlFileRequisition">
    <el-page-header content="续控申请单" @back="back"></el-page-header>
    <el-row>
      <el-col :span="18">
        <el-form >
          <el-row>
            ...
            <el-col :span="8" class="timeLang">
              <el-form-item label="续控时长(天)">
                <el-input type="number" size="mini" v-model="formObj.xqDay" placeholder="请输入数字格式"></el-input>
              </el-form-item>
            </el-col>
...
export default {
  ...
  methods: {
    ...
    // 提交
    async save() {
      if (!this.formObj.xqDay) {
        this.$message.warning("请填写续控时长");
      } else {
        let saveflag = await addControlFileForm(this.formObj);
        if (saveflag == 200) {
          this.$message({
            type: "success",
            message: "续控成功！"
