<template>
  <div id="moveControlFile">
    <el-page-header content="多维档案" @back="back"></el-page-header>
    <div class="main">
      <div>
        <p>布控对象:</p>
          ...
          <el-row class="personInfo">
            ...
            <el-col :span="6">
              ...
              <p>是否重点人员:
                ...
                <a  v-if="formObj.multi.sfzdry" class="el-button el-button--text el-button--mini" :href="dimensionsUrl+'/workObject/workManagementDetail/'+formObj.multi.zdryId+'?name='+formObj.multi.name" target="_blank">查看详情</a>
              </p>
              <p>是否僧尼:
                <span>{{formObj.multi.sfsr |sfgr}}</span>
                <a  v-if="formObj.multi.sfsr" class="el-button el-button--text el-button--mini" :href="dimensionsUrl+'/place-manage/faculty-detail/'+formObj.multi.jzryId+'?name='+formObj.multi.name" target="_blank">查看详情</a>
              </p>
            </el-col>
            <el-col :span="10">
              <p>标签:</p>
        ...
        <el-collapse-item name="2">
          ...
          <div>
            <span class="el-tag el-tag--light" v-for="(item,index) in phoneList" :key="index">
                <el-checkbox-group v-model="formObj.multi.sjh">
        ...
        <el-collapse-item name="3">
          ...
          <div>
            <span class="el-tag el-tag--light" v-for="(item,index) in carList" :key="index">
              <el-checkbox-group v-model="formObj.multi.cph">
                  <el-checkbox :label="item.value"></el-checkbox>
              </el-checkbox-group>
        ...
        <el-collapse-item name="4">
          ...
          <div>
            <span class="el-tag el-tag--light" v-for="(item,index) in macList" :key="index">
              <el-checkbox-group v-model="formObj.multi.mac">
                <el-checkbox :label="item.value"></el-checkbox>
              </el-checkbox-group>
...
export default {
  ...
  methods: {
    ...
    remove(item, index, type) {
      if (this.formObj.multi[type].indexOf(item[index].value) != -1) {
        this.formObj.multi[type].splice(
          this.formObj.multi[type].indexOf(item[index].value),
          1
        );
      }
      item.splice(index, 1);
